package dev.th0rgal.skinmotion.bukkit.spigot;
...
public final class SpigotSkinApplier {
    ...
    private static synchronized void init() {
        ...
        try {
            ...
            try {
                ...
                System.err.println("[SkinMotion] Failed to initialize Spigot skin applier: " + e2.getMessage());
                available = false;
            }
        }
    }
    ...
    public static void applySkin(@NotNull Player player, @NotNull SkinProperty property) {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to apply skin via Spigot: " + e.getMessage());
        }
    }
    ...
    public static SkinProperty getSkinProperty(@NotNull Player player) {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to get skin via Spigot: " + e.getMessage());
        }
