...
public final class SkinApplierBungee {
    ...
    private static synchronized void init() {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to initialize BungeeCord skin applier: " + e.getMessage());
            available = false;
        }
    }
    ...
    public void applySkin(@NotNull ProxiedPlayer player, @NotNull SkinProperty property) {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to apply skin to " + player.getName() + ": " + e.getMessage());
        }
    }
    ...
    public static void applyToHandler(@NotNull PendingConnection handler, @NotNull SkinProperty property) {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to apply skin to handler: " + e.getMessage());
        }
    }
    ...
    public SkinProperty getSkinProperty(@NotNull ProxiedPlayer player) {
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to get skin from " + player.getName() + ": " + e.getMessage());
        }
