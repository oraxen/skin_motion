package dev.th0rgal.skinmotion.bungee.commands;

import dev.th0rgal.skinmotion.bungee.SkinMotionBungee;
...
public final class CapeCommand extends Command implements TabExecutor {
    ...
    private final SkinMotionBungee plugin;

    public CapeCommand(SkinMotionBungee plugin) {
