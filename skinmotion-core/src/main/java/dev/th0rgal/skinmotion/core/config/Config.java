package dev.th0rgal.skinmotion.core.config;
...
public final class Config {
    ...
    // SkinMotion settings
    private String pluginApiKey;
    private String serverId;
    private boolean sendLinkOnJoin;
    ...
    public static Config load(@NotNull File dataFolder) {
        ...
        try (InputStream input = new FileInputStream(configFile)) {
            ...
            System.err.println("[SkinMotion] Failed to load config: " + e.getMessage());
        }
    ...
    private void loadFromMap(Map<String, Object> data) {
        ...
        if (api != null) {
            ...
            this.pluginApiKey = getString(api, "plugin_api_key", "");
            this.serverId = getString(api, "server_id", DEFAULT_SERVER_ID);
        }

        Map<String, Object> skin = (Map<String, Object>) data.get("skin");
        if (skin != null) {
            this.sendLinkOnJoin = getBoolean(skin, "send_link_on_join", true);
        }
    ...
    public void save(@NotNull File configFile) {
        ...
        api.put("plugin_api_key", pluginApiKey);
        api.put("server_id", serverId);
        data.put("api", api);

        Map<String, Object> skin = new LinkedHashMap<>();
        skin.put("send_link_on_join", sendLinkOnJoin);
        data.put("skin", skin);
        ...
        try {
            ...
            System.err.println("[SkinMotion] Failed to save config: " + e.getMessage());
        }
    }
    ...
    public String getPluginApiKey() {
        return pluginApiKey != null ? pluginApiKey : "";
    }

    @NotNull
    public String getServerId() {
        return serverId != null ? serverId : DEFAULT_SERVER_ID;
    }

    public boolean isSendLinkOnJoin() {
        return sendLinkOnJoin;
    }
